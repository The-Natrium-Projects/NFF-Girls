...
public class HmagRedcapEntity extends RedcapEntity implements INFFGirlsTamed {
	...
	public void aiStep()
	{
		...
		{			
			...
			&& this.hasLineOfSight(this.getOwner()))
			{
				...
				NaUtilsEntityStatics.addEffectSafe(this.getOwner(), MobEffects.DIG_SPEED, 10, ampl);
			}
		}
	}
	...
	public NFFTamedInventoryMenu makeMenu(int containerId, Inventory playerInventory, Container container) {
		return new NFFGirlsHmagRedcapInventoryMenu(containerId, playerInventory, container, this);
	}
