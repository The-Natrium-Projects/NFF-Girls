...
/*
	...
	{
		NFUEntityStatics.addEffectSafe(this, new MobEffectInstance(MobEffects.DAMAGE_BOOST, 60 * 20, 2));
	...
	protected static class LeapAtTargetGoal extends NFFLeapAtTargetGoal
	{
		...
		{
			return super.getMaxAttackDistance() - 3.0F * ((float)jiangshi.getSpeedBonus() / (float) SPEED_BONUS_MAX);
		}

		@Override
		public double getXZSpeed()
		{
			return super.getXZSpeed() + 0.3D * ((double)jiangshi.getSpeedBonus() / (double) SPEED_BONUS_MAX);
		}
	}
