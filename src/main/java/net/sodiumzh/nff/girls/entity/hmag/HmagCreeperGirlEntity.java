...
import net.sodiumzh.nff.girls.entity.ai.goal.NFFGirlsCreeperFollowOwnerGoal;
...
public class HmagCreeperGirlEntity extends NFFTamedCreeperPreset implements INFFGirlsTamed
{
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new NFFGirlsCreeperFollowOwnerGoal(this, 1.0d, 5.0f, 2.0f, false));
