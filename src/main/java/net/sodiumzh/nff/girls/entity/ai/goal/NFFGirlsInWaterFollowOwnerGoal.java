...
public class NFFGirlsInWaterFollowOwnerGoal extends NFFFollowOwnerGoal {
	...
	public NFFGirlsInWaterFollowOwnerGoal(@Nonnull INFFTamed inMob, double pSpeedModifier, float pStartDistance,
			float pStopDistance) {
