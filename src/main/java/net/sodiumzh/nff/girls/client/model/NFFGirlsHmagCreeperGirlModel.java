...
@OnlyIn(Dist.CLIENT)
public class NFFGirlsHmagCreeperGirlModel<T extends HmagCreeperGirlEntity> extends AbstractAdvancedGirlModel<T>
{
	public NFFGirlsHmagCreeperGirlModel(ModelPart modelPart)
	{
		super(modelPart);
	}
