package net.sodiumzh.nff.girls.client.model;
...
@OnlyIn(Dist.CLIENT)
public class NFFGirlsHmagEnderExecutorModel<T extends HmagEnderExecutorEntity> extends AbstractGirlModel<T>
{
...
//		private ModelPart skirt5;
	...
	public NFFGirlsHmagEnderExecutorModel(ModelPart modelPart)
		{
			super(modelPart);
...
//			this.skirt5 = this.skirt4.getChild("skirt_5");
	...
	public static MeshDefinition createMesh(CubeDeformation cd) {
		...
		PartDefinition rapd = ModClientUtils.addC(pd, cd, "right_arm", 40, 16, 0.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F,
				-5.0F, 2.0F + f, 0.0F);
		PartDefinition lapd = ModClientUtils.addC(pd, cd, "left_arm", 40, 16, -2.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F,
				5.0F, 2.0F + f, 0.0F, true);
		ModClientUtils.addC(rapd, cd, "right_arm_part_1", 0, 40, -0.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 3.0F,
				0.0F);
		ModClientUtils.addC(lapd, cd, "left_arm_part_1", 0, 40, -2.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 3.0F, 0.0F,
				true);
		ModClientUtils.addC(rapd, cd, "right_arm_part_2", 0, 40, -0.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 7.0F,
				0.0F);
		ModClientUtils.addC(lapd, cd, "left_arm_part_2", 0, 40, -2.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 7.0F, 0.0F,
				true);
		PartDefinition rlpd = ModClientUtils.addC(pd, cd, "right_leg", 16, 32, -1.0F, 0.0F, -1.0F, 2.0F, 30.0F, 2.0F,
				-2.0F, 12.0F + f, 0.0F);
		PartDefinition llpd = ModClientUtils.addC(pd, cd, "left_leg", 16, 32, -1.0F, 0.0F, -1.0F, 2.0F, 30.0F, 2.0F,
				2.0F, 12.0F + f, 0.0F, true);
		ModClientUtils.addC(rlpd, cd, "right_leg_part_1", 0, 44, -1.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 16.0F,
				0.0F);
		ModClientUtils.addC(llpd, cd, "left_leg_part_1", 0, 44, -1.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 16.0F, 0.0F,
				true);
		ModClientUtils.addC(rlpd, cd, "right_leg_part_2", 0, 44, -1.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 18.0F,
				0.0F);
		ModClientUtils.addC(llpd, cd, "left_leg_part_2", 0, 44, -1.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 18.0F, 0.0F,
				true);
		PartDefinition bodypd = pd.getChild("body");
		ModClientUtils.addC(bodypd, cd, "bust", 0, 32, -3.0F, -1.5F, -1.5F, 6.0F, 3.0F, 3.0F, 0.0F, 3.5F, -1.1F,
				-0.005F);
		ModClientUtils.addC(bodypd, cd, "skirt_1", 0, 64, -3.5F, 0.0F, -2.0F, 7.0F, 2.0F, 4.0F, 0.0F, 11.0F, 0.0F);
		PartDefinition s2pd = ModClientUtils.addC(bodypd, cd, "skirt_2", 24, 64, -4.0F, 0.0F, -2.5F, 8.0F, 2.0F, 5.0F,
				0.0F, 13.0F, 0.0F);
		PartDefinition s3pd = ModClientUtils.addC(s2pd, cd, "skirt_3", 0, 72, -4.5F, 0.0F, -3.0F, 9.0F, 2.0F, 6.0F,
				0.0F, 2.0F, 0.0F);
		PartDefinition s4pd = ModClientUtils.addC(s3pd, cd, "skirt_4", 0, 80, -5.0F, 0.0F, -3.5F, 10.0F, 2.0F, 7.0F,
				0.0F, 2.0F, 0.0F);
		...
		PartDefinition rhpd = ModClientUtils.addC(headpd, cd, "right_hair_1", 24, 32, -1.0F, -1.5F, -1.0F, 2.0F, 14.0F,
				2.0F, -4.25F, -8.0F, 3.5F);
		PartDefinition lhpd = ModClientUtils.addC(headpd, cd, "left_hair_1", 24, 32, -1.0F, -1.5F, -1.0F, 2.0F, 14.0F,
				2.0F, 4.25F, -8.0F, 3.5F, true);
		ModClientUtils.addC(rhpd, cd, "right_hair_2", 32, 32, -1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F, 0.0F, 12.5F, 0.0F);
		ModClientUtils.addC(lhpd, cd, "left_hair_2", 32, 32, -1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F, 0.0F, 12.5F, 0.0F,
				true);
		return md;
	}
...
//			this.skirt5.xRot = 0.0F;
		...
		{
			this.rightHair1.zRot += Mth.sin(this.animationAmount * this.animationAmount * ((float) Math.PI / 1.2F))
					* 0.75F;
			this.leftHair1.zRot -= Mth.sin(this.animationAmount * this.animationAmount * ((float) Math.PI / 1.2F))
					* 0.75F;
		}
