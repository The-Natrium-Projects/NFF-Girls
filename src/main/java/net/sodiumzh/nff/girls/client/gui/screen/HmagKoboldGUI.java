...
public class HmagKoboldGUI extends NFFGirlsHandItemsTwoBaublesGUI
{
	
	public HmagKoboldGUI(NFFTamedInventoryMenu pMenu, Inventory pPlayerInventory, INFFTamed mob)
	{
