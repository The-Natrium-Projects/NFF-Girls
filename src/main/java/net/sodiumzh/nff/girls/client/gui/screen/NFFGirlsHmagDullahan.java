...
public class NFFGirlsHmagDullahan extends NFFGirlsGuiPreset0
{
	public NFFGirlsHmagDullahan(NFFTamedInventoryMenu menu, Inventory playerInventory, INFFTamed mob)
	{
