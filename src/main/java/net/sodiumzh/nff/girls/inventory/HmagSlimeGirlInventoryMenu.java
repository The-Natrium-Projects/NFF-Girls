...
public class HmagSlimeGirlInventoryMenu extends NFFGirlsInventoryMenuPreset0
{
	
	public HmagSlimeGirlInventoryMenu(int containerId, Inventory playerInventory, Container container,
			INFFTamed mob) {
