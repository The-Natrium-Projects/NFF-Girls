...
public class NFFGirlsEquipmentTwoBaublesInventoryMenu extends NFFGirlsInventoryMenuPreset0{

	public NFFGirlsEquipmentTwoBaublesInventoryMenu(int containerId, Inventory playerInventory, Container container,
			INFFTamed mob) {
