...
public class NFFGirlsSlimeGirlInventoryMenu extends NFFGirlsInventoryMenuPreset0
{
	
	public NFFGirlsSlimeGirlInventoryMenu(int containerId, Inventory playerInventory, Container container,
			INFFTamed mob) {
