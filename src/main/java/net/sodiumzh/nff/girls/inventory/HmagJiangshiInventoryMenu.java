...
public class HmagJiangshiInventoryMenu extends NFFGirlsInventoryMenuPreset0
{

	public HmagJiangshiInventoryMenu(int containerId, Inventory playerInventory, Container container, INFFTamed mob)
	{
