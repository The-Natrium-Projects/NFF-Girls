...
public class NFFGirlsGhastlySeekerInventoryMenu extends NFFGirlsInventoryMenuPreset0
{

	public NFFGirlsGhastlySeekerInventoryMenu(int containerId, Inventory playerInventory, Container container,
			INFFTamed mob) {
