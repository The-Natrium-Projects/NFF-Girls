...
public class NFFGirlsZombieGirlInventoryMenu extends NFFGirlsInventoryMenuPreset0
{

	public NFFGirlsZombieGirlInventoryMenu(int containerId, Inventory playerInventory, Container container,
			INFFTamed mob)
	{
