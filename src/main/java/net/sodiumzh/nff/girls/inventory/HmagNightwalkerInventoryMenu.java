...
public class HmagNightwalkerInventoryMenu extends NFFGirlsInventoryMenuPreset0
{
	
	public HmagNightwalkerInventoryMenu(int containerId, Inventory playerInventory, Container container, INFFTamed mob)
	{
