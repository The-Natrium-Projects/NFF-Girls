...
public class HmagGhastlySeekerInventoryMenu extends NFFGirlsInventoryMenuPreset0
{

	public HmagGhastlySeekerInventoryMenu(int containerId, Inventory playerInventory, Container container,
			INFFTamed mob) {
