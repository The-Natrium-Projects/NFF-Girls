...
public class NFFGirlsTrades
{
	...
	public static final RegistryEntryCollection<VanillaTradeListing> LISTINGS = RegistryEntryCollection.create(NaUtilsRegistries.VANILLA_TRADE_LISTINGS,
		NFFGirls.MOD_ID);
	...
	static
	{
		...
		.readAndPop().push("nffgirls:hmag_drowned_girl")
		.linkListings(COMMON_UNDEAD)
		.setRequiredLevel(2)
		...
		.readAndPop().push("nffgirls:hmag_skeleton_girl")
		.linkListings(COMMON_UNDEAD)
		.setRequiredLevel(5)
		.addSells(128, 128, Items.SKELETON_SPAWN_EGG, 1, 1, 1).weight(0.2d)
		
		.readAndPop().push("nffgirls:hmag_stray_girl")
		.linkListings(COMMON_UNDEAD)
		.setRequiredLevel(4)
		...
		.readAndPop().push("nffgirls:hmag_wither_skeleton_girl")
		.linkListings(COMMON_UNDEAD)
		.setRequiredLevel(3)
		...
		.readAndPop().push("nffgirls:hmag_creeper_girl")
		.setRequiredLevel(1)
		...
		.readAndPop().push("nffgirls:hmag_necrotic_reaper")
		.linkListings(COMMON_UNDEAD)
		.setRequiredLevel(3)
		...
		try {
			...
			// Common part
				...
				.addBuys(Items.SKELETON_SKULL, 1, 1, 1, 1, 2)
				.addBuys(gaiaItem("rotten_heart"), 1, 1, 1, 1, 2)
				.addBuys(byKey("iceandfire:ectoplasm"), 12, 16, 1, 1, 4)
				.addBuys(byKey("alexsmobs:soul_heart"), 1, 1, 1, 1, 4)
				.addBuys(byKey("iceandfire:dread_shard"), 16, 20, 1, 1, 4)
				.setRequiredLevel(5)
				...
				.addBuys(byKey("twilightforest:arctic_fur"), 16, 24, 1, 1, 4)
				.setRequiredLevel(3)
				.addSells(1, 1, Items.BLUE_ICE, 6, 10, 4)
				.addBuys(byKey("iceandfire:troll_leather_frost"), 6, 8, 1, 1, 4)
				.addBuys(byKey("iceandfire:sapphire_gem"), 8, 12, 1, 1, 4)
				.setRequiredLevel(4)
				.addBuys(byKey("iceandfire:ice_dragon_blood"), 2, 3, 4, 8, 4)
				.readAndPop()

				.push(COMMON_ARCHER)
				.setRequiredLevel(1)
				.addBuys(Items.ARROW, 84, 100, 1, 1, 4)
				.setRequiredLevel(4)
				.addBuys(gaiaItem("bag_arrows"), 1, 1, 2, 3, 2)
				.addBuys(byKey("iceandfire:dragonbone_arrow"), 12, 16, 1, 1, 4)
				.readAndPop()
				...
				.addBuys(Items.FIRE_CHARGE, 16, 32, 1, 1, 4)
				.addBuys(byKey("byg:anthracite"), 28, 36, 1, 1, 4)
				.setRequiredLevel(2)
				.addBuys(Items.TNT, 8, 12, 1, 1, 4)
				.addBuys(byKey("byg:brim_powder"), 36, 48, 1, 1, 4)
			...
			TRADES.setCurrency(NFFGirlsItems.EVIL_GEM.get())
				...
				.linkListings(COMMON_UNDEAD)
				.setRequiredLevel(4)
				.addBuys(byKey("iceandfire:troll_skull"), 1, 1, 4, 6, 2)
				.setRequiredLevel(5)
				.addSells(32, 46, byKey("twilightforest:zombie_scepter"), 1, 1, 1)
				.addSells(128, 128, Items.ZOMBIE_SPAWN_EGG, 1, 1, 1).weight(0.1d)
				.readAndPop()
				...
				.addBuys(byKey("byg:aloe_vera"), 24, 32, 1, 1, 4)
				.addBuys(byKey("byg:baobab_fruit"), 48, 64, 1, 1, 4)
				.setRequiredLevel(3)
				.addBuys(byKey("alexsmobs:rattlesnake_rattle"), 4, 6, 1, 1, 4)
				.addBuys(byKey("alexsmobs:tarantura_hawk_wing_fragment"), 4, 6, 1, 1, 4)
				.addSells(1, 1, Items.RABBIT_FOOT, 1, 1, 4)
				.setRequiredLevel(4)
				.addBuys(gaiaItem("weapon_book_hunger"), 1, 1, 4, 6, 2)
				.addBuys(byKey("iceandfire:myrmex_desert_chitin"), 4, 8, 1, 1, 4)
				.addSells(6, 12, byKey("alexsmobs:guster_eye"), 1, 1, 2)
				.setRequiredLevel(5)
				.addSells(32, 46, byKey("twilightforest:crumble_horn"), 1, 1, 1)
				.addSells(16, 24, byKey("iceandfire:deathworm_tounge"), 1, 1, 1)
				.addSells(128, 128, Items.HUSK_SPAWN_EGG, 1, 1, 1).weight(0.1d)
				.readAndPop()
				...
				.addBuys(byKey("iceandfire:seaserpent_skull"), 1, 1, 6, 8, 2)
				.addBuys(byKey("iceandfire:shiny_scales"), 4, 8, 1, 1, 2)
				.addSells(2, 4, byKey("alexsmobs:rainbow_jelly"), 1, 1, 8)
				.setRequiredLevel(5)
				.addSells(32, 40, Items.HEART_OF_THE_SEA, 1, 1, 1)
				.addSells(32, 40, byKey("iceandfire:tide_trident"), 1, 1, 1)
				.addSells(16, 24, byKey("iceandfire:hippocampus_fin"), 1, 1, 1)
				.addSells(24, 30, byKey("alexsmobs:ambergris"), 1, 1, 2)
				.addSells(128, 128, Items.DROWNED_SPAWN_EGG, 1, 1, 1).weight(0.1d)
				.readAndPop()
				...
				.addSells(128, 128, Items.SKELETON_SPAWN_EGG, 1, 1, 1).weight(0.1)
				.readAndPop()
				...
				.addBuys(byKey("alexsmobs:froststalker_horn"), 2, 3, 1, 1, 4)
				.addSells(1, 1, byKey("twilightforest:ice_bomb"), 3, 5, 2)
				.setRequiredLevel(5)
				.addSells(24, 32, byKey("twilightforest:ice_bow"), 1, 1, 1)
				...
				.addBuys(byKey("iceandfire:witherbone"), 12, 16, 1, 1, 4)
				.addBuys(byKey("alexsmobs:dropbear_claw"), 5, 8, 1, 1, 4)
				.addBuys(byKey("alexsmobs:bone_serpent_tooth"), 5, 8, 1, 1, 4)
				...
				.addSells(52, 60, byKey("twilightforest:seeker_bow"), 1, 1, 1).weight(0.5d)
				.addSells(128, 128, Items.WITHER_SKELETON_SPAWN_EGG, 1, 1, 1).weight(0.05d)

				.readAndPop().push(NFFGirlsEntityTypes.HMAG_CREEPER_GIRL.getId())
				.setRequiredLevel(3)
				.addBuys(Items.REDSTONE, 40, 48, 1, 1, 4)
				.addSells(1, 1, Items.REPEATER, 3, 4, 4)
				.addSells(1, 1, Items.COMPARATOR, 2, 3, 4)
				//.addSells(2, 2, gaiaItem("projectile_bomb"), 1, 1, 8)
				.setRequiredLevel(4)
				.addSells(1, 1, ModItems.LIGHTNING_PARTICLE.get(), 1, 1, 4)
				.addSells(1, 1, ModItems.EXP_BERRY.get(), 2, 2, 4)
				...
				.addSells(16, 24, byKey("twilightforest:charm_of_keeping_2"), 1, 1, 1).weight(0.5)
				...
				.addBuys(byKey("alexsmobs:cosmic_cod"), 18, 24, 1, 1, 4)
				...
				.addSells(1, 1, byKey("alexsmobs:mimicream"), 2, 4, 4)
				.addSells(1, 1, byKey("alexsmobs:caspid"), 2, 4, 4)
				.addSells(1, 1, ModItems.DYSSOMNIA_SKIN.get(), 2, 2, 2)
				.setRequiredLevel(5)
				.addBuys(gaiaItem("doll_ender_girl"), 1, 1, 8, 12, 2)
				.addBuys(Items.DRAGON_HEAD, 1, 1, 4, 5, 4)
				.addSells(32, 48, Items.DRAGON_EGG, 1, 1, 2)
				.addSells(32, 64, byKey("twilightforest:ender_bow"), 1, 1, 2)

				.readAndPop().push(NFFGirlsEntityTypes.HMAG_KOBOLD.getId())
				.setRequiredLevel(1)
				.addBuys(Items.COAL, 48, 64, 1, 1, 4)
				...
				.addBuys(byKey("twilightforest:giant_pickaxe"), 1, 1, 3, 5, 4)
				.addBuys(byKey("alexsmobs:ghostly_pickaxe"), 1, 1, 4, 6, 2)
				.setRequiredLevel(5)
				.addBuys(Items.SCULK_SENSOR, 20, 28, 1, 1, 4)
				.addSells(3, 4, Items.SCULK_CATALYST, 1, 1, 2)
				.addSells(8, 12, Items.ECHO_SHARD, 1, 1, 2).weight(0.5)
				.addSells(32, 40, byKey("twilightforest:mazebreaker_pickaxe"), 1, 1, 1).weight(0.2)
				.addEnchantsBook(8, 10, Enchantments.BLOCK_EFFICIENCY, 5, 2)

				.readAndPop().push("nffgirls:hmag_melty_monster")
				.setRequiredLevel(1)
				...
				.setRequiredLevel(3)
				.addBuys(ModItems.FIRE_BOTTLE.get(), 6, 12, 1, 2, 8)
				.addBuys(byKey("iceandfire:fire_dragon_blood"), 6, 10, 1, 3, 8)
				.addSells(2, 4, ModItems.BURNING_CORE.get(), 2, 3, 8)
				.addSells(2, 4, ModItems.CRIMSON_CUTICULA.get(), 2, 3, 8)
				.setRequiredLevel(4)
				...
				.setRequiredLevel(5)
				/*.addSells(64, 96, ModItems.LIFE_JADE_II.get(), 1, 1, 2)
				.addSells(64, 96, ModItems.COURAGE_AMULET_II.get(), 1, 1, 2)
				.addSells(64, 96, ModItems.RESISTANCE_AMULET_II.get(), 1, 1, 2)
				.addSells(96, 128, ModItems.SOUL_AMULET_IV.get(), 1, 1, 2)*/
				...
				.setRequiredLevel(1)
				.addBuys(Items.WHITE_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.ORANGE_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.MAGENTA_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.LIGHT_BLUE_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.YELLOW_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.LIME_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.PINK_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.GRAY_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.LIGHT_GRAY_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.CYAN_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.PURPLE_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.BLUE_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.BROWN_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.GREEN_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.RED_DYE, 48, 64, 1, 1, 16)
				.addBuys(Items.BLACK_DYE, 48, 64, 1, 1, 16)
				.setRequiredLevel(2)
				.addBuys(Items.SLIME_BALL, 36, 48, 1, 1, 16)
				...
				.addSellsEnchantmentBook(4, 6, Enchantments.SHARPNESS, 5, 2)
				.setRequiredLevel(1)
				.addBuys(Items.ROTTEN_FLESH, 56, 64, 1, 1, 16)
				.addBuys(Items.BONE, 56, 64, 1, 1, 16)
				.addBuys(Items.FLINT, 48, 56, 1, 1, 16)
				.addBuys(Items.STRING, 56, 64, 1, 1, 16)
				.setRequiredLevel(2)
				.addBuys(Items.COAL, 56, 64, 1, 1, 16)
				.addBuys(Items.CHARCOAL, 56, 64, 1, 1, 16)
				.addSells(2, 4, ModItems.SOUL_POWDER.get(), 4, 8, 8)
				.setRequiredLevel(3)
				.addBuys(ModItems.SOUL_APPLE.get(), 3, 5, 1, 1, 8)
				.addBuys(byKey("iceandfire:dread_shard"), 6, 10, 1, 1, 8)
				.addBuys(byKey("alexsmobs:skreecher_soul"), 2, 4, 1, 1, 8)
				.addSells(4, 6, ModItems.NECROFIBER.get(), 1, 1, 16)
				.addSells(6, 8, ModItems.LICH_CLOTH.get(), 1, 1, 8)
				.setRequiredLevel(4)
				.addBuys(Items.ECHO_SHARD, 8, 12, 1, 2, 8)
				.addBuys(gaiaItem("cursed_metal_sword"), 1, 1, 6, 8, 2)
				.addSells(6, 8, ModItems.REINFORCING_CHAIN.get(), 1, 1, 16)
				.addSells(6, 8, ModItems.DYSSOMNIA_SKIN.get(), 1, 1, 8)
				.setRequiredLevel(5)
				//.addBuys(Items.NETHER_HOE, 1, 1, 6, 8, 4)
				.addSells(8, 10, Items.TOTEM_OF_UNDYING, 1, 1, 4)
				.addSells(12, 32, ModItems.MULTIPLEX_REINFORCING_CHAIN.get(), 1, 1, 4)
				.addSellsEnchantmentBook(84, 112, Enchantments.SHARPNESS, 10, 2)
				.addSellsEnchantmentBook(72, 96, Enchantments.SWIFT_SNEAK, 5, 2)
				.addSells(48, 64, byKey("twilightforest:twilight_scepter"), 1, 1, 2)
