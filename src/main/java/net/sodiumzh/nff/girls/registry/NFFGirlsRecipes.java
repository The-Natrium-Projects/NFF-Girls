...
public class NFFGirlsRecipes
{
	...
	public static final RegistryObject<RecipeSerializer<?>> MAGICAL_GEL_SEPARATE = RECIPES.register("magical_gel_separate", () -> new SimpleRecipeSerializer<>(MagicalGelSeperateRecipe::new));
	...
	public static final RegistryObject<RecipeSerializer<?>> ATTACKING_STRATEGY_LIST_DUPLICATE = RECIPES.register("attacking_strategy_list_duplicate", () -> new SimpleRecipeSerializer<>(AttackingStrategyListDuplicationRecipe::new));
}
